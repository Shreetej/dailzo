...
func SetupRoutes(
	...
	api.Get("/payment/:id", middleware.JWTMiddleware(), paymentController.GetPaymentById)
	...
	api.Get("/order/:id", middleware.JWTMiddleware(), orderController.GetOrderById)
	...
	api.Get("/orderitem/:id", middleware.JWTMiddleware(), orderItemController.GetOrderItemById)
	...
	api.Get("/paymethod/:id", middleware.JWTMiddleware(), paymentMethodController.GetPaymentMethodById)
	...
	api.Get("/rating/:id", middleware.JWTMiddleware(), ratingController.GetRatingById)
	...
	api.Get("/refund/:id", middleware.JWTMiddleware(), refundController.GetRefundById)
	...
	api.Get("/restaurant/:id", middleware.JWTMiddleware(), restaurantController.GetRestaurantById)
